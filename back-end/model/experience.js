...
const experienceSchema = new Schema({
    ...
    company: { fa: { type: String, required: true }, en: { type: String, required: true } },
    jobType: { fa: { type: String, required: true }, en: { type: String, required: true } },
    jobTime: { fa: { type: String, required: true }, en: { type: String, required: true } },
