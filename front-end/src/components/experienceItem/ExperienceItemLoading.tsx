      ...
      <div className="w-full group hidden md:flex">
        <div className="w-44 min-w-[176px] text-end">
          <div className="flex justify-end">
            <div className="w-16 h-5 rounded-sm bg-gray-100 dark:bg-gray-50/20 animate-pulse"></div>
        ...
        <div className="pb-7 group-last:pb-0 w-full">
          <div className="w-36 h-5 rounded-sm bg-gray-100 dark:bg-gray-50/20 animate-pulse"></div>
